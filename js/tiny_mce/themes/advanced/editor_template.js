	...
	e
			.create(
					"tinymce.themes.AdvancedTheme",
					{
						...
						stateControls : [ "bold", "italic", "underline",
						...
						init : function(j, k) {
							...
							if (e.is(m.theme_advanced_font_sizes, "string")) {
								m.font_size_style_values = e
										.explode(m.font_size_style_values);
								m.font_size_classes = e
										.explode(m.font_size_classes || "");
								n = {};
								j.settings.theme_advanced_font_sizes = m.theme_advanced_font_sizes;
								f(j.getParam("theme_advanced_font_sizes", "",
										"hash"), function(q, p) {
									var o;
									if (p == q && q >= 1 && q <= 7) {
										p = q + " (" + l.sizes[q - 1] + "pt)";
										o = m.font_size_classes[q - 1];
										q = m.font_size_style_values[q - 1]
												|| (l.sizes[q - 1] + "pt")
									}
									if (/^\s*\./.test(q)) {
										o = q.replace(/\./g, "")
							...
							if ((i = m.theme_advanced_path_location)
									&& i != "none") {
							...
							j.onInit
									.add(function() {
										if (!j.settings.readonly) {
											j.onNodeChange.add(l._nodeChanged,
													l)
										}
										if (j.settings.content_css !== false) {
											j.dom
													.loadCSS(j.baseURI
															.toAbsolute("themes/advanced/skins/"
																	+ j.settings.skin
																	+ "/content.css"))
										}
									});
							...
							d.loadCSS(m.editor_css ? j.documentBaseURI
									.toAbsolute(m.editor_css) : k + "/skins/"
									+ j.settings.skin + "/ui.css");
							if (m.skin_variant) {
								d.loadCSS(k + "/skins/" + j.settings.skin
										+ "/ui_" + m.skin_variant + ".css")
							}
						},
						...
						_importClasses : function(k) {
							var i = this.editor, j = i.controlManager
									.get("styleselect");
							if (j.getLength() == 0) {
						...
						_createStyleSelect : function(m) {
							...
							i.onInit.add(function() {
								...
								if (n) {
									...
									f(i.getParam("theme_advanced_styles", "",
											"hash"), function(r, q) {
										var p;
										if (r) {
											p = "style_" + (o++);
							...
							if (l.getLength() == 0) {
								l.onPostRender.add(function(o, p) {
									if (!l.NativeListBox) {
										b.add(p.id + "_text", "focus",
												k._importClasses, k);
										b.add(p.id + "_text", "mousedown",
												k._importClasses, k);
										b.add(p.id + "_open", "focus",
												k._importClasses, k);
										b.add(p.id + "_open", "mousedown",
												k._importClasses, k)
									} else {
										b.add(p.id, "focus", k._importClasses,
												k)
									}
								})
							}
								...
								f(
										i
												.getParam(
														...
														j.settings.theme_advanced_fonts,
														"hash"),
										function(m, l) {
											k
													.add(
											...
											"fontsizeselect",
											{
												...
												onselect : function(i) {
													if (i.fontSize) {
														...
														f(
																m.settings.theme_advanced_font_sizes,
																function(p, o) {
																	if (p["class"]) {
																		j
																				.push(p["class"])
						...
						_createBlockFormats : function() {
							...
							k = j.editor.controlManager.createListBox(
									"formatselect", {
								...
								f(
										j.editor
												.getParam(
														...
														j.settings.theme_advanced_blockformats,
														"hash"),
										function(m, l) {
											k
													.add(
						...
						_createForeColorMenu : function() {
							...
							l.cmd = "ForeColor";
							l.scope = this;
							m = j.editor.controlManager.createColorSplitButton(
									"forecolor", l);
							return m
						},
						...
						renderUI : function(k) {
							...
							m = j = d.create("span", {
								...
								"class" : "mceEditor "
										...
										+ "Skin"
										+ (w.skin_variant ? " "
												+ r.settings.skin + "Skin"
												+ v._ufirst(w.skin_variant)
												: "")
							});
							if (!d.boxModel) {
								m = d.add(m, "div", {
							...
							m = q = d.add(m, "tbody");
							switch ((w.theme_advanced_layout_manager || "")
									.toLowerCase()) {
							case "rowlayout":
							...
							case "customlayout":
								l = r.execCallback(
										"theme_advanced_custom_layout", w, q,
										k, j);
								break;
							default:
							...
							m = k.targetNode;
							i = d.stdMode ? u.getElementsByTagName("tr")
									: u.rows;
							...
							if (d.get(w.theme_advanced_toolbar_container)) {
								d.get(w.theme_advanced_toolbar_container)
										.appendChild(j)
							} else {
								d.insertAfter(j, m)
							}
						...
						resizeBy : function(i, j) {
							...
							this
									.resizeTo(k.clientWidth + i, k.clientHeight
											+ j)
						},
						resizeTo : function(i, l) {
							var j = this.editor, k = j.settings, n = d.get(j.id
									+ "_tbl"), o = d.get(j.id + "_ifr"), m;
							i = Math.max(
									k.theme_advanced_resizing_min_width || 100,
									i);
							l = Math
									.max(
											k.theme_advanced_resizing_min_height || 100,
											l);
							i = Math
									.min(
											k.theme_advanced_resizing_max_width || 65535,
											i);
							l = Math
									.min(
											k.theme_advanced_resizing_max_height || 65535,
											l);
						...
						_simpleLayout : function(y, r, k, i) {
							...
							if (v == "external") {
								...
								u.onMouseUp.add(function() {
									...
									d.show(o);
									d.hide(g);
									var n = b.add(u.id + "_external_close",
											"click", function() {
									...
									d.show(o);
									d.setStyle(o, "top", 0 - d.getRect(u.id
											+ "_tblext").h - 1);
									d.hide(o);
									d.show(o);
									o.style.filter = "";
						...
						_rowLayout : function(w, m, k) {
							...
							x = w.theme_advanced_containers_default_align
									|| "center";
							f(
									c(w.theme_advanced_containers || ""),
									function(s, o) {
										var n = w["theme_advanced_container_"
												+ s]
												|| "";
						...
						_addControls : function(j, i) {
							...
							f(c(j), function(p) {
								...
								if (p == "tablecontrols") {
									f( [ "table", "|", "row_props",
											"cell_props", "|", "row_before",
											"row_after", "delete_row", "|",
											"col_before", "col_after",
											"delete_col", "|", "split_cells",
											"merge_cells" ], function(q) {
						...
						_addToolbars : function(w, k) {
							...
							for (p = 1; (y = A["theme_advanced_buttons" + p]); p++) {
								...
								if (A["theme_advanced_buttons" + p + "_add"]) {
									y += ","
											+ A["theme_advanced_buttons" + p
													+ "_add"]
								}
								if (A["theme_advanced_buttons" + p
										+ "_add_before"]) {
									y = A["theme_advanced_buttons" + p
											+ "_add_before"]
											+ "," + y
								}
								z._addControls(y, m);
							...
							q.push(d.createHTML("a", {
								...
								accesskey : "z",
								title : r.getLang("advanced.toolbar_focus"),
								onfocus : "tinyMCE.getInstanceById('" + r.id
										+ "').focus();"
							}, "<!-- IE -->"));
							d.setHTML(l, q.join(""))
						},
						_addStatusBar : function(m, j) {
							...
							k = d.add(k, "div", {
								id : p.id + "_path_row"
							}, w.theme_advanced_path ? p
									.translate("advanced.path")
									+ ": " : "&#160;");
							d.add(k, "a", {
								href : "#",
								accesskey : "x"
									...
									p.onPostRender
											.add(function() {
												...
												if (w.theme_advanced_resize_horizontal) {
													r.style.width = Math.max(
															10, n.cw)
															+ "px"
												}
												r.style.height = Math.max(10,
														n.ch)
														+ "px";
												d.get(p.id + "_ifr").style.height = Math
														.max(10, parseInt(n.ch)
																+ v.deltaHeight)
														+ "px"
											})
								}
						...
						_nodeChanged : function(o, x, l, u, j) {
							...
							e.each(A.stateControls, function(n) {
								x.setActive(n, o
										.queryCommandState(A.controls[n][1]))
							});
							function m(p) {
							...
							x.setDisabled("undo", !o.undoManager.hasUndo()
									&& !o.typing);
							x.setDisabled("redo", !o.undoManager.hasRedo());
							x.setDisabled("outdent", !o
									.queryCommandState("Outdent"));
							i = m("A");
							if (q = x.get("link")) {
								if (!i || !i.name) {
									q.setDisabled(!i && u);
							...
							if (q = x.get("fontsizeselect")) {
								if (B.theme_advanced_runtime_fontsize && !k
										&& !y) {
							...
							if (B.theme_advanced_path
									&& B.theme_advanced_statusbar_location) {
								i = d.get(o.id + "_path")
										|| d.add(o.id + "_path_row", "span", {
											id : o.id + "_path"
										});
								d.setHTML(i, "");
								m(
						...
						_sel : function(i) {
							this.editor.execCommand("mceSelectNodeDepth",
									false, i)
						},
									...
									.open(
											{
												...
												width : 320 + parseInt(i
														.getLang(
																"advanced.anchor_delta_width",
																0)),
												height : 90 + parseInt(i
														.getLang(
						...
						_mceCharMap : function() {
							...
							i.windowManager.open( {
								...
								width : 550 + parseInt(i.getLang(
										"advanced.charmap_delta_width", 0)),
								height : 250 + parseInt(i.getLang(
										"advanced.charmap_delta_height", 0)),
								inline : true
							}, {
								theme_url : this.url
							})
									...
									.open(
											{
												...
												width : 375 + parseInt(i
														.getLang(
																"advanced.colorpicker_delta_width",
																0)),
												height : 250 + parseInt(i
														.getLang(
						...
						_mceCodeEditor : function(j, k) {
							...
							i.windowManager.open( {
								...
								width : parseInt(i.getParam(
										"theme_advanced_source_editor_width",
										720)),
								height : parseInt(i.getParam(
						...
						_mceImage : function(j, k) {
							var i = this.editor;
							if (i.dom.getAttrib(i.selection.getNode(), "class")
									.indexOf("mceItem") != -1) {
								return
							}
							i.windowManager.open( {
								url : e.baseURL + "/themes/advanced/image.htm",
								width : 355 + parseInt(i.getLang(
										"advanced.image_delta_width", 0)),
								height : 275 + parseInt(i.getLang(
										"advanced.image_delta_height", 0)),
								inline : true
							}, {
								theme_url : this.url
							})
						...
						_mceLink : function(j, k) {
							...
							i.windowManager.open( {
								...
								width : 310 + parseInt(i.getLang(
										"advanced.link_delta_width", 0)),
								height : 200 + parseInt(i.getLang(
										"advanced.link_delta_height", 0)),
								inline : true
							}, {
								theme_url : this.url
							})
						...
						_mceNewDocument : function() {
							var i = this.editor;
							i.windowManager.confirm("advanced.newdocument",
									function(j) {
										if (j) {
											i.execCommand("mceSetContent",
													false, "")
										}
									})
						},
						...
						_mceBackColor : function() {
							...
							this._mceColorPicker(0, {
								...
								func : function(j) {
									i.bgColor = j;
									i.editor.execCommand("HiliteColor", false,
											j)
								}
							})
						},
